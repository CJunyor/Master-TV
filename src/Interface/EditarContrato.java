...
public class EditarContrato extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Editar Contrato");
    ...
    private void pFConfirmarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pFConfirmarMouseClicked
        ...
        else if(!(rbRegular.isSelected() || rbIlimitado.isSelected() || rbIlimitado.isSelected())){
            JOptionPane.showMessageDialog(rootPane, "Plano não escolhido", "Erro!", ERROR_MESSAGE);
            lPlano.setForeground(Color.red);
            return;
        }
    ...
    public ConsultarContratos getContrato() {
        return contrato;
    }

    public void setContrato(ConsultarContratos contrato) {
